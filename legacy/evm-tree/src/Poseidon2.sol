...
/// @title Poseidon2 t=2 Merkle compression over BN254 Fr (HorizenLabs zkhash POSEIDON2_BN256_PARAMS_2).
/// @notice Constants transcribed verbatim from poseidon2_const.circom @ e6a69f0 (POSEIDON_*(2)).
///         Validated 2026-06-15: compress(1,2) == circom == Rust keystone vector.
contract Poseidon2 is IHasher {
    uint256 internal constant P =
        21888242871839275222246405745257275088548364400416034343698204186575808495617;
    uint256 internal constant R_P = 56;
    ...
    function compress(uint256 l, uint256 r) external pure returns (uint256) {
        (uint256 o0, ) = perm(l, r); return addmod(o0, l, P);
    }
}
