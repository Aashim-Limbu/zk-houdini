...
/// Poseidon2 t=2 Merkle compression over BN254 Fr (fork PoseidonCompress = Permutation(2)).
/// Constants transcribed from poseidon2_const.circom @ e6a69f0 (POSEIDON_*(2)).
contract Poseidon2 {
